...
class SatelliteMonitoringScreenV2 extends StatefulWidget {
  final String? initialFieldId;
  const SatelliteMonitoringScreenV2({super.key, this.initialFieldId});

  @override
  State<SatelliteMonitoringScreenV2> createState() =>
      _SatelliteMonitoringScreenV2State();
}

class _SatelliteMonitoringScreenV2State
    extends State<SatelliteMonitoringScreenV2> {
